...
String linea3 = " Si quieres tener exito, promete todo y no cumplas nada";
String linea4 = " Napoleon";
String linea5 = " El saber es la parte principal de la felicidad";
String linea6 = " Socrates";
...
// delay(0);
  ...
  if(stringStart2 > stringStop2){
    ...
    */
    ...
    lcd.print(linea5.substring(stringStart3,stringStop3));
    if(stringStart3 == 0 && scrollCursor3 > 0){
      scrollCursor3--;
      stringStop3++;
    }
    else if (stringStop3 == linea5.length() && scrollCursor3 == 0) {
      stringStart3++;
    }
    else {
      stringStart3++;
